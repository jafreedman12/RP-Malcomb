...
### Original replication by Kufre Udoh, Joseph Holler, and Middlebury College Spring 2019 Geography 323 class
...
vulnerability = function(geo) {
  ...
  final = (geo) * 0.60 + drought * 0.20 + flood * 0.20
}
```
...
vuln_map = ggplot() +
  ...
  scale_fill_gradient(
    low = "#FFFF75",
    high = "#CF4611",
    breaks = c(1.508731, 8.162132), #c(35.81, 42.42), 
    labels = c("Lower Vulnerability", "Higher Vulnerability"),
    na.value = "transparent",
    guide = "colourbar",
    limits = c(1.508731, 8.162132) #c(35.81, 42.42) 
  ) +
  scale_x_continuous(breaks = c(33,34,35,36)) +
...
diffadaptive = ggplot() +
  ...
  labs(title = "Difference in adaptive capacity between Malcomb et. al (2014) and Reproduction") +
  theme_minimal() +
  theme(
    legend.title = element_blank(),
    axis.title.x = element_blank(),
