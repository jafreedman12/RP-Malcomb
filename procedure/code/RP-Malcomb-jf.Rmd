...
diffcompare = ggplot() +
  ...
  labs(title = "Difference in adaptive capacity between Malcomb et. al (2014) and Replication") +
  theme_minimal() +
  theme(
    legend.title = element_blank(),
    axis.title.x = element_blank(),
...
diffrastermap = ggplot() +
  ...
  scale_fill_gradient2(
    ...
    labels = c("Diverging 1", "zero", "Diverging 2"),
    na.value = "transparent",
    guide = "colourbar",
    limits = c(-0.98, 0, 0.736)
  ) +
  scale_x_continuous(breaks = c(33,34,35,36)) +
  labs(title = "Malawi Vulnerability to Climate Change") +
  theme_minimal() +
